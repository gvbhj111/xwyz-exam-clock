...
exams[271] = {
  ...
  schedule() {
    $("英语", "2025-06-03", "20:30", "22:30");
    $("语文", "2025-06-04", "09:30", "12:00");
    $("数学", "2025-06-04", "15:00", "17:00");
    $("生物", "2025-06-04", "21:15", "22:30");
    $("物理", "2025-06-05", "09:00", "10:15");
    $("化学", "2025-06-05", "10:45", "12:00");
  }
};
...
exams[272] = {
  ...
  rollSlogan: ["宣威一中高一下学期期中考试：请以实际时间为准。"],
  schedule() {
    $("英语", "2025-04-27", "20:30", "22:30");
    $("语文", "2025-04-28", "09:30", "12:00");
    $("数学", "2025-04-28", "15:00", "17:00");
    $("地理", "2025-04-28", "21:15", "22:30");
    $("历史", "2025-04-29", "09:00", "10:15");
    $("政治", "2025-04-29", "10:45", "12:00");
  }
};
