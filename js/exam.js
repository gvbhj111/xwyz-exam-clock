...
exams[271] = {
  ...
  author: "来源:高一年级",
  origin: "高一年级部",
  rollSlogan: ["宣威一中高一下学期开学考试：请以实际时间为准。"],
  schedule() {
    $("生物", "2025-02-23", "19:00", "20:30");
    $("英语", "2025-02-24", "15:00", "17:00");
    $("历史", "2025-02-23", "21:00", "22:30");
    $("物理", "2025-02-24", "19:00", "20:30");
    $("数学", "2025-02-25", "15:00", "17:00");
    $("化学", "2025-02-25", "08:40", "10:10");
    $("语文", "2025-02-24", "09:30", "12:00");
    $("政治", "2025-02-24", "21:00", "22:30");
    $("地理", "2025-02-25", "10:30", "12:00");
  }
};
