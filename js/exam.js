...
exams[271] = {
  ...
  author: "来源:高一年级",
  origin: "高一年级部",
  rollSlogan: ["宣威市2025学年高一春季学期期末考试：请以实际时间为准。"],
  schedule() {
    $("语文", "2025-07-06", "09:30", "12:00");
    $("英语", "2025-07-06", "15:00", "17:00");
    $("生物", "2025-07-07", "21:15", "22:30");
    $("物理", "2025-07-07", "09:00", "10:15");
    $("化学", "2025-07-08", "10:45", "12:00");
    $("数学", "2025-07-08", "15:00", "17:00");
  }
};
...
exams[272] = {
  ...
  author: "来源:高一年级",
  origin: "高一年级部",
  rollSlogan: ["宣威市2025年春季学期高一期末考试：请以实际时间为准。"],
  schedule() {
...
exams[302] = {
  ...
  author: "云南省招生考试院",
  origin: "学考",
  rollSlogan: ["云南省普通高中学业水平考试（模拟）"],
  schedule() {
    $("历史","2025-06-16", "08:30", "10:00");
    $("通用技术", "2025-06-16", "11:00", "11:50");
    $("地理", "2025-06-16", "14:00", "15:30");
    $("生物学", "2025-06-16", "16:30", "18:00");
    $("语文", "2025-06-17", "08:30", "10:30");
    $("物理","2025-06-17", "14:00", "15:30");
    $("英语", "2025-06-17", "16:30", "18:10");
    $("数学", "2025-06-18", "08:30", "10:10");
    $("信息技术", "2025-06-18", "11:10", "12:00");
    $("化学", "2025-06-18", "14:00", "15:30");
    $("思想政治", "2025-06-18", "16:30", "18:10");
  }
};
